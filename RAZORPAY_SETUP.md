...
|--------------|-------------|---------|
| `RAZORPAY_KEY_ID` | Razorpay API Key ID (backend) | `rzp_test_xxxxxxxxxxxxx` |
| `RAZORPAY_KEY_SECRET` | Razorpay API Secret (backend) | `your_secret_key_here` |
| `NEXT_PUBLIC_RAZORPAY_KEY_ID` | Razorpay Key ID (frontend) | `rzp_test_xxxxxxxxxxxxx` |
...
- ✅ Ensure webhook URL is configured in Razorpay (if needed)
